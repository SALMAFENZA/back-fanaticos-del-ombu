let itineraries = [
  {
    cityld: "636fca0425d63341f230ebc1",
    name: "Canal Cruise",
    photo: [
    ...
    description:
      "Cruise Amsterdams famous canals during this 75-minute boat tour. Climb aboard the classic wooden saloon boat and sit back and enjoy the beautiful city passing by. See landmarks as you savor Dutch cheese and sip a drink.",
    price: 40,
    duration: 75,
  ...
  {
    cityld: "636fca0425d63341f230ebc2",
  ...
  },
  {
    ...
    description:
      "Discover the best of Barcelona on this comfortable, non-stop bus tour from City Sightseeing. Choose between a 1-day or 2-day pass, relax on the open-top double-decker bus and enjoy your own sightseeing itinerary as you travel along various routes and learn about the landmarks through on-board narration.",
    price: 0,
    duration: 0,
    userId: "636f1edc14f79b76f5e442bc",
  },
  {
    cityld: "636fca0425d63341f230ebc3",
    ...
    description:
      "Enhance your experience of one of Chinas greatest architectural feats on a small group tour of the Great Wall of China from Beijing. Accompanied by an expert guide, explore the ancient Mutianyu section of the wall and ascend the Ming Dynasty watchtowers for panoramic views of the spectacular surrounding landscape.",
    price: 120,
    duration: 480,
    userId: "636f1edc14f79b76f5e442b9",
  },
  {
    cityld: "636fca0425d63341f230ebcc",
    ...
    description:
      "The Forbidden City, or Palace Museum, is the largest palace complex in the world, with more than 800 buildings and some 8,000 rooms in the heart of Beijing. Considered off-limits to visitors for some five centuries, today this UNESCO World Heritage Site is one of the citys most popular attractions.",
    price: 55,
    duration: 240,
    userId: "636f1edc14f79b76f5e442ba",
  },
